                ...
                function (a) {
                    ...
                    []; m.models = {}; m.models.oSearch = { bCaseInsensitive: !0, sSearch: "", bRegex: !1, bSmart: !0 }; m.models.oRow = { nTr: null, anCells: null, _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, _sRowStripe: "", src: null }; m.models.oColumn = {
                        ...
                        fnStateLoaded: null, fnStateSaveCallback: function (a, b) { try { (-1 === a.iStateDuration ? sessionStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b)) } catch (c) { } }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
                            oAria: { sSortAscending: ": فعال سازی مرتب سازی صعودی", sSortDescending: ": فعال سازی مرتب سازی نزولی" }, oPaginate: { sFirst: "اولین", sLast: "آخرین", sNext: "بعدی", sPrevious: "قبلی" },
                            sEmptyTable: "داده ای برای نمایش وجود ندارد", sInfo: "نمایش _START_ تا _END_ از _TOTAL_ تعداد", sInfoEmpty: "نمایش 0 تا 0 از 0 مقادیر", sInfoFiltered: "فیلتر شده از _MAX_ تعداد کل)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "نمایش تعداد _MENU_ در صفحه", sLoadingRecords: "در حال بارگذاری...", sProcessing: "در حال پردازش...", sSearch: "جستجو:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "رکوردی یافت نشد"
                        }, oSearch: h.extend({}, m.models.oSearch), sAjaxDataProp: "داده", sAjaxSource: null, sDom: "lfrtip", searchDelay: null,
                        ...
                        m.ext.classes, {
                            ...
                            simple: function () { return ["previous", "next"] }, full: function () { return ["first", "previous", "next", "last"] }, simple_numbers: function (a, b) {
                                return ["previous",
                                    Wa(a, b), "next"]
                            }, full_numbers: function (a, b) { return ["اولین", "قبلی", Wa(a, b), "بعدی", "آخرین"] }, _numbers: Wa, numbers_length: 7
